...
export class ManoCincoService {
  ...
  comienzaJuego(id: number) {
    ...
    this.randonMano(5, 1); // genera la mano de la IA
  ...
  comprobarGanador(playerId: number, computerId: number) {
    ...
    const ganaJugador =
      ...
      (playerId === 1 && computerId === 4) ||
      (playerId === 2 && computerId === 1) ||
      (playerId === 2 && computerId === 5) ||
      (playerId === 3 && computerId === 2) ||
      (playerId === 3 && computerId === 4) ||
      (playerId === 4 && computerId === 2) ||
      (playerId === 4 && computerId === 5) ||
      (playerId === 5 && computerId === 3) ||
      (playerId === 5 && computerId === 1);
